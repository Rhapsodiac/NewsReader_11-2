...
implements OnItemClickListener {
    ...
    public void onResume() {
        ...
        if (feedPubDateMillis == -1) {
            Log.i("News Reader", "DownloadFeed executed");
            new DownloadFeed().execute();   // download, read, and display
        }
        else if (feed == null) {
            Log.i("News Reader", "ReadFeed executed");
            new ReadFeed().execute();       // read and display
        }
        else {
            Log.i("News Reader", "just updateDisplay");
    ...
    class DownloadFeed extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            Log.i("News reader", "Feed downloaded");
    ...
    public void updateDisplay()
    {
        ...
        Log.i("News reader", "Feed displayed");
    }
